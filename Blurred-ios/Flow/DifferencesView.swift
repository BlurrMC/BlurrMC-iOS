...
/// Come on now! Not modifying things is for babies!
//
...
@IBDesignable
public class DifferencesView: UIView {
    ...
    private func createGroup() {
        group = UIView(frame: CGRect(x: 18.5, y: 18.5, width: 16, height: 16))
        ...
        group.layer.bounds = CGRect(x: 0, y: 0, width: 16, height: 16)
    ...
    private func createDot0() {
        ...
        dot0.shapeLayer.fillColor = UIColor(red: 0.455, green: 0.282, blue: 0.988, alpha: 1).cgColor
    ...
    private func createDot1() {
        dot1 = ShapeView(frame: CGRect(x: 4, y: 12, width: 8, height: 8))
        ...
        dot1.layer.position = CGPoint(x: 4, y: 12)
    ...
    private func createDot2() {
        dot2 = ShapeView(frame: CGRect(x: 12, y: 4, width: 8, height: 8))
        ...
        dot2.layer.position = CGPoint(x: 12, y: 4)
    ...
    private func createDot3() {
        dot3 = ShapeView(frame: CGRect(x: 12, y: 12, width: 8, height: 8))
        ...
        dot3.layer.position = CGPoint(x: 12, y: 12)
        ...
        dot3.shapeLayer.fillColor = UIColor(red: 0.992, green: 0.004, blue: 0.471, alpha: 1).cgColor

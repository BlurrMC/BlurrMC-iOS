...
class NotificationSettingsViewController: UIViewController {
    ...
    func getNotificationSettings() {
        ...
        AF.request("https://www.bartenderdogseatmuffins.xyz/api/v1/notification_settings", method: .get, encoding: JSONEncoding.default, headers: headers).responseJSON { (response) in
    ...
    func notificationNetworkRequest(controller: String) {
        ...
        AF.request("https://www.bartenderdogseatmuffins.xyz/api/v1/\(controller)", method: .patch, encoding: JSONEncoding.default, headers: headers).responseJSON { (response) in

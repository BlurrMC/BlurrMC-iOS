...
class EnableOTP2ViewController: UIViewController {
    ...
    func checkOTP() {
        ...
        AF.request("https://blurrmc.com/api/v1/two_factor_settings/verifyotp", method: .post, parameters: params, encoding: JSONEncoding.default, headers: headers).responseJSON { (response) in
